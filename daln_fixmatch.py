...
def main(args: argparse.Namespace):
    ...
    train_source_dataset, train_target_dataset, val_dataset, test_dataset, num_classes, args.class_name = \
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
          model: ImageClassifier, domain_discrepancy, optimizer: SGD, lr_scheduler: LambdaLR, epoch: int,
