...
def main(args: argparse.Namespace):
    ...
    # instantiate NWD
    discrepancy = NuclearWassersteinDiscrepancy(target_classifier.head).to(device)

    # define optimizer and lr scheduler
    # note that we only optimize target feature extractor
    optimizer = SGD(target_classifier.get_parameters(), args.lr,
    ...
    for epoch in range(args.epochs):
        ...
        # train for one epoch
        train(train_source_iter, train_target_iter, source_classifier, target_classifier, discrepancy,
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
          source_model: ImageClassifier, target_model: ImageClassifier, domain_discrepancy,
